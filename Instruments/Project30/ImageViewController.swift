...
class ImageViewController: UIViewController {
    ...
    override func viewDidDisappear(_ animated: Bool) {
        ...
        // MARK: - destroy the timer here in order to resolve a strong reference cycle formed in viewDidLoad()
    ...
    override func viewDidLoad() {
        ...
        // MARK: - use UIImage(contentsOfFile:) instead of UIImage(named:) because the latter initialiser caches the image, which uses up memory
